...
$q = "select * from sekreterler where tc='$sekreterTc';";
...
<table class="table">
  ...
  <tbody>
    <?php
    $q = "select * from mail where email='$sekreterMail';";
    $r = mysqli_query($conn,$q);
    ?>
...
<div class="container mt-5">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" disabled value="<?php echo htmlspecialchars(trim(stripslashes($sekreterMail))); ?>"  id="sender" name="sender" required>
            </div>
            <div class="mb-3">
